...
const Skill=()=>{
    const skills = [
        ...
        { name: 'Javascript', description: 'I first used Javascript in 1998 and I was a heave jQuery user' },
        { name: 'Java', description: 'I was an early adopter of Java in 1996. I published several books and hundreds of articles on Java.' },
        { name: 'C++', description: 'I did C and C++ for six years. I wrote a C++-based RPG and Cobol debugger and in AS/400 performance tuner.' },
