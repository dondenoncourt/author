...
Publishment.create(title: 'On Getting Old(er) in Tech', link: 'https://dev.to/corgibytes/on-getting-older-in-tech', summary: 'My life story of four decades of development and how I stay competitive. This post was read by half a million people within one month of publication.', published_at: '2016-12-05', style: 'post')

Publishment.create(title: 'My Quest for Mediocrity', link: 'https://corgibytes.com/blog/2016/08/30/quest-for-mediocrity/', summary: 'I cover my tongue-in-cheek strategy for self-improvement by surrounding myself with better-than-average developers.', published_at: '2016-08-30', image: 'matthew-kalapuch-7psXKRl2amU-unsplash.jpg', style: 'post')

Publishment.create(title: 'I Lied About My Role Model in a Job Interview', link: 'https://corgibytes.com/blog/2015/10/25/role-model/', summary: 'The title is true but it is click bait. It really is about my real role model and mentor.', published_at: '2015-10-25', style: 'post')
